...
export default function Hero(){
    ...
    return <section className="text-center px-5 py-32 bg-secondary" id="about">
        ...
        <div className="py-7">
            <p className="text-2xl font-hero-font text-gray-400">Check My Resume <a className="btn sky-blue hover:text-white" target="_blank" href="https://purple-angelique-47.tiiny.site/"><button className="text-black bg-button hover:text-blue-800 text text-3xl">View</button></a></p>
        </div>
