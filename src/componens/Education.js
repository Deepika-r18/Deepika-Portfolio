    ...
    return <section className="font-hero-font bg-primary " id="education">
        <div>
            ...
            <div className="flex justify-center py-5 flex-col md:flex-row gap-8" >
                <div className="card-education  my-3 text-center animation">
                ...
                <div className="card-education   my-0 px-7 text-center">
                    <h1 className="font-bold text-white py-2 text-2xl hover:text-gray-400">Bachelor of Computer Applications</h1>
